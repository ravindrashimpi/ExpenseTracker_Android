...
class CategoryAdapter(
    ...
    isDelete: Boolean,
    listner: OnListInteractionListener
) : RecyclerView.Adapter<CategoryAdapter.CategoryViewHolder>() {
    private val TAG = "CategoryAdapter"
    private var categoryList = catList
    private var deleteItem = isDelete
    private lateinit var view: LinearLayout
    private var count: Int = 0
    private var mListner: OnListInteractionListener = listner
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CategoryViewHolder {
        ...
        if (deleteItem) {
            val delImg = view.findViewById<ImageView>(R.id.deleteCategory)
...
//    }
     ...
     * Method used to get the gradient atlease once
     */
//    private fun getCircleGradient(count: Int) = when (count) {
//        0 -> R.drawable.custom_circle_gradient_1
//        1 -> R.drawable.custom_circle_gradient_2
//        2 -> R.drawable.custom_circle_gradient_3
//        3 -> R.drawable.custom_circle_gradient_4
